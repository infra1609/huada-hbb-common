...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("HuadaRemote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["yc.hdhqne.com:21116"];
pub const RS_PUB_KEY: &str = "tuePL+2uoCQ9p6K5wzLaThjg0ih+wytGLDWyaX+smWM=";
